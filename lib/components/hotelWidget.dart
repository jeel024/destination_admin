...
class MostFavouriteHotelWidget extends StatelessWidget {
  final List<HotelModel> mostFavouritePlaces;

  MostFavouriteHotelWidget(this.mostFavouritePlaces);
        ...
        children: [
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              HotelModel item = mostFavouritePlaces[index];
              return Row(
                children: [
                  Container(
